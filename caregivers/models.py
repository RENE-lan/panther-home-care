...
class Applicant(models.Model):
    ...
    source = models.CharField(max_length=80, blank=True, help_text="Origine (recommandation, annonce…)")
    experience = models.CharField(max_length=200, blank=True)
    assessment_score = models.PositiveIntegerField(null=True, blank=True)
...
class ApplicantEvent(models.Model):
    """Recruitment flow trail: each stage move + note."""
    applicant = models.ForeignKey("caregivers.Applicant", on_delete=models.CASCADE, related_name="events")
