...
class IncidentAttachment(models.Model):
    """Photo or video attached to an incident."""
    KIND = [("PHOTO", "Photo"), ("VIDEO", "Vidéo"), ("FILE", "Fichier")]
    ...
    kind = models.CharField(max_length=6, choices=KIND, default="PHOTO")
...
class IncidentEvent(models.Model):
    """Tracker timeline: status changes and notes on an incident."""
    incident = models.ForeignKey("incidents.Incident", on_delete=models.CASCADE, related_name="events")
