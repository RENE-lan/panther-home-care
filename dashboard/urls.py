...
urlpatterns = [
    ...
    path("clients/<int:pk>/ask/", views.client_ask, name="client_ask"),
    ...
    path("caregivers/<int:pk>/edit/", views.caregiver_edit, name="caregiver_edit"),
    ...
    path("recruitment/new/", views.applicant_new, name="applicant_new"),
    path("recruitment/<int:pk>/", views.applicant_detail, name="applicant_detail"),
    path("recruitment/<int:pk>/advance/", views.applicant_advance, name="applicant_advance"),
    ...
    path("billing/<int:pk>/pay/", views.record_payment, name="record_payment"),
    ...
    path("billing/invoice/<int:pk>/view/", views.invoice_view, name="invoice_view"),
    # AI Copilot
    ...
    path("coverage/", views.coverage_gaps, name="coverage"),
    path("command/", views.command_bar, name="command"),
    # Communications
    path("communications/", views.communications, name="communications"),
    path("messages/", views.messages_center, name="messages_inbox"),
    path("messages/<int:pk>/<str:topic>/", views.messages_center, name="client_conversation"),
    ...
    path("portal/privacy/", views.family_privacy, name="family_privacy"),
    path("portal/assistant/", views.family_assistant, name="family_assistant"),
    path("portal/assistant/ask/", views.family_assistant_ask, name="family_assistant_ask"),
    ...
    path("access/", views.access_matrix, name="access_matrix"),
]