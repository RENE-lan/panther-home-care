...
class Command(BaseCommand):
    ...
    def handle(self, *args, **opts):
        ...
        from clients.models import Client as _Cl
        for _c in _Cl.objects.all():
            if not _c.family_code:
                _c.family_code = _sec.token_hex(3).upper()
                _c.save(update_fields=["family_code"])
